...
const organizationSchema = {
  ...
  "@type": "Organization",
  name: "Aria",
  url: "https://aria.seawolfai.net",
  logo: "https://aria.seawolfai.net/favicon.ico",
  sameAs: ["https://github.com/claycampbell/openclaw-crm", "https://x.com/402BoxIO"],
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Aria is a free, open-source, self-hosted CRM with native AI agent integration. Your AI agent manages contacts, deals, tasks, and notes through natural language. It ships with a built-in AI chat assistant, a full REST API, and deploys with Docker Compose. MIT licensed with no per-seat pricing.",
      },
    },
    {
      "@type": "Question",
      name: "How does the AI agent work with Aria?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Aria integrates with your Aria Bot in two minutes. Generate a skill file from Settings, drop it into your agent config, and your bot can create contacts, update deals, log notes, search data, and manage tasks from wherever you already talk to it. Inside the CRM, a built-in AI chat assistant also analyzes your data and takes actions.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Aria is MIT licensed and completely free. There is no per-seat pricing and no paywalled features. You can use the hosted version or self-host it on your own infrastructure with full data ownership.",
      },
    },
  ],
};
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3 mr-3 sm:mr-6">
              <TrackedAnchor
                ...
                eventProps={{ url: "https://github.com/claycampbell/openclaw-crm", link_text: "GitHub nav icon" }}
              >
      ...
      <section className="relative mx-auto max-w-5xl px-6 pt-36 pb-12 sm:pt-48 sm:pb-20">
        <div className="text-center">
          ...
          <p className="landing-fade-up-1 mt-6 text-[15px] leading-relaxed text-muted-foreground/70">
            Open-source. Self-hosted. Connect your Aria Bot in 2 minutes.
          </p>
          ...
          <div className="landing-fade-up-2 mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <TrackedAnchor
              ...
              eventProps={{ url: "https://github.com/claycampbell/openclaw-crm", link_text: "View on GitHub" }}
            >
          ...
          <ScrollReveal delay={0} className="h-full">
            <div className="h-full rounded-2xl border border-foreground/[0.06] dark:border-white/[0.06] bg-foreground/[0.015] dark:bg-white/[0.02] px-7 py-7 transition-[border-color,background-color,box-shadow,transform] duration-150 hover:border-foreground/20 dark:hover:border-white/15 hover:bg-foreground/[0.025] dark:hover:bg-white/[0.035] hover:shadow-[0_4px_20px_-6px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_4px_24px_-6px_rgba(0,0,0,0.4)] hover:-translate-y-0.5">
              ...
              <p className="mt-2 text-[14px] leading-[1.65] text-muted-foreground">
                Connect your Aria Bot in 2 minutes. Manage contacts, deals,
        ...
        <div className="mx-auto flex max-w-5xl flex-col sm:flex-row items-center justify-between gap-4 px-6 py-6 sm:py-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <TrackedAnchor
              ...
              rel="noopener noreferrer"
              className="text-[12px] text-muted-foreground/60 transition-colors hover:text-muted-foreground"
              eventProps={{ url: "https://github.com/claycampbell/openclaw-crm", link_text: "GitHub footer" }}
            >
              GitHub
            </TrackedAnchor>
            <TrackedAnchor
